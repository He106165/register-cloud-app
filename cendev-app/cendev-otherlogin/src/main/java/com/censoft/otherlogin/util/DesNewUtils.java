package com.censoft.otherlogin.util;
...
public class DesNewUtils {
    ...
    public static void main(String[] args) {
        ...
        String encData = "123321";
        String encStr = desObj.strEnc(encData, key);
        System.out.println("加密后："+encStr);

        String decData = "351373E16B0E2312618DAB8D22B172AE";
        String decStr = desObj.strDec(decData, key);
     ...
     */
    public String strEnc(String data, String key) {
...
>>>>>>> origin/develop
     ...
     */
    public String strDec(String data, String key) {
        int leng = data.length();
        String decStr = "";
        List firstKeyBt = null;
        int firstLength = 0;
