package com.censoft.userManage.consulateUser.mapper;
 ...
 */
@Mapper
public interface ConsulateInfoMapper
{
    /**
     * 查询领使馆用户
     *
     ...
     *  根据用户名获取第一条数据 （登陆）
     * */
    public ConsulateInfo getUserByName(@Param("userName") String userName);
}
