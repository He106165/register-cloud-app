package com.censoft.common.redis.aspect;
...
public class RedisAspect
{
     ...
     */
    @Pointcut("@annotation(com.censoft.common.redis.annotation.RedisCache)")
    public void redisCachePoint()
    {
    }

    @Pointcut("@annotation(com.censoft.common.redis.annotation.RedisEvict)")
