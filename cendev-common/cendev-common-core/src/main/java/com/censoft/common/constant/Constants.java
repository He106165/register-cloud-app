...
public class Constants
{
     ...
     * 踢除
     */
    public static final String KICK_LOGOUT           = "KickLogout";
    ...
    public final static String REGISTER_TOKEN     = "REGISTER_TOKEN_";

    public final static String ACCESS_USERID    = "access_userid_";

    public final static String BLACK_TOKEN   = "black_token_";

    public final static String USER_PERMS    = "user_perms";
